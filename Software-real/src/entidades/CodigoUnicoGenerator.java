...
public class CodigoUnicoGenerator {
    public static String gerarCodigo(String identificadorUsuario) throws RuntimeException, NoSuchAlgorithmException {
        ...
        for(int i = 0; i<16; i++){ sb.append(Integer.toString((hash[i] & 0xFF) | 0x100, 36).substring(1).toUpperCase()); }
